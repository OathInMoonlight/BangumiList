import type { LanguageType } from "@/plugins/types"

type detectLanguageType = LanguageType | "#"

type FirstLetterType =  "a" | "b" | "c" | "d" |
    "e" | "f" | "g" | "h" |
    "i" | "j" | "k" | "l" |
    "m" | "n" | "o" | "p" |
    "q" | "r" | "s" | "t" |
...
interface LanguageTool {
    ...
    detectLanguage: (letter: string) => detectLanguageType,
