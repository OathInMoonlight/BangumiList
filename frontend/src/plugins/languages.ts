import type { Languages } from "@/plugins/types"
...
const languages: Languages = {
    ...
    text: {
        ...
        columnNameZH: { "zh": "列名称(中文)", "ja": "列名(中国語)", "en": "Column Name (Chinese)" },
        columnNameJA: { "zh": "列名称(日本語)", "ja": "列名(日本語)", "en": "Column Name (Japanese)" },
        columnNameEN: { "zh": "列名称(English)", "ja": "列名(英語)", "en": "Column Name (English)" },
        columnWidth: { "zh": "列宽度", "ja": "列幅", "en": "Column Width" },
        tight: { "zh": "紧凑", "ja": "タイト", "en": "Tight" },
        flex: { "zh": "自适应", "ja": "フレックス", "en": "Flex" },
        columnDefaultShow: { "zh": "列默认显示", "ja": "列のデフォルト表示", "en": "Column Default Show" },
